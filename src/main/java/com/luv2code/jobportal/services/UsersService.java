...
public class UsersService {
    ...
    @Autowired
    public UsersService(JobRecommendationService jobRecommendationService, UsersRepository usersRepository,
    ...
    public Object getCurrentUserProfile() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                String path = "photos/candidate/"
                        + jobSeekerProfile.getUserAccountId() + "/"
                        + jobSeekerProfile.getResume();
                // jobRecommendationService.getRecommendedJobs(path);
